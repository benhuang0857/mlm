                ...
                <div class="card-body">
                    ...
                    @if ($PRODUCT->category == '美妝')
                        @switch($USER->levelcat01)
                            ...
                            @default
                        @endswitch
                    @elseif($PRODUCT->category == '保健')
                        @switch($USER->levelcat02)
                            @case("A")
                            {{$PRODUCT->a_price}}
                                @break
                            @case("B")
